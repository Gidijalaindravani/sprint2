...
public class PatientAPP {
		...
		public static void main(String[] args) {
			...
			try { 
				...
				factory  = Persistence.createEntityManagerFactory("indhu");
						
				EntityManager em = factory.createEntityManager();
									
			System.out.println("------WELCOME TO PatientManagementSystem------");
						
	PatientEntity P1 = new PatientEntity (1, "HYMA", "VATHI", "Female","B-Positive",  "06-12-2023");
	PatientEntity P2 = new PatientEntity(2, "INDRA", "VANI", "Male","O-Positive",  "12-12-2023");
	PatientEntity P3 = new PatientEntity(3, "JAYA", "LAKSHMI", "Female","A-Negative", "20-12-2023");
	//PatientEntity P4 = new PatientEntity(4, "Vamshi", "krishna", "Male","A-Negative", "30-12-2023");			
		...
		//				tDAO.save(P4);
						...
						int  newid = 3;
						String newFirstName ="HYMA" ;
						String newLastName = "VATHI" ;
